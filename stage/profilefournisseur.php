<?php
    ...
    if(!isset($_SESSION['email'])){
      ...
      $ad = Fournisseur::getOne2($_SESSION['id']);
?>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="form-group centerrow">
                                    ...
                                    <img class="img-profile rounded-circle" src="img/fournisseur/<?php echo $_SESSION['image']; ?>" height='150px' width='150px'>
                                    </div>
                                </div>
                                <style>
                                    .centerrow{
