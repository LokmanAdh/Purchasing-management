<?php
    ...
    if(!isset($_SESSION['email'])){
      ...
      if(isset($_GET['oldemail']) && isset($_GET['oldimage'])){
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form  action="include/confirmfournisseur.php" enctype="multipart/form-data" method="post">
                                ...
                                <input type="submit" class ="btn btn-primary btn-user btn-block" value="Edit" name='updatefournisseur'>
                            </form>
                        </div>
                    </div>
