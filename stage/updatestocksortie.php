<?php
    ...
    if(!isset($_SESSION['email'])){
      ...
      if(isset($_GET['oldref']) && isset($_GET['oldid']) && isset($_GET['olddate']) && isset($_GET['oldquantite'])){
        $_SESSION['oldref']=$_GET['oldref'];
          $_SESSION['oldid']=$_GET['oldid'];
          $_SESSION['olddate']=$_GET['olddate'];
          $_SESSION['oldquantite']=$_GET['oldquantite'];
    }
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form  action="include/confirmstocksortie.php" enctype="multipart/form-data" method="post">
                                ...
                                <input type="submit" class ="btn btn-primary btn-user btn-block" value="Edit" name='updatestocksortie'>
                            </form>
                        </div>
                    </div>
